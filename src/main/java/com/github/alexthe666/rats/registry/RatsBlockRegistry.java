...
public class RatsBlockRegistry {
	...
	public static final DeferredHolder<Block, Block> RAT_TRAP = register("rat_trap", key -> new RatTrapBlock(RatsRegistryHelper.withBlockId(key, Block.Properties.of()).sound(SoundType.WOOD).noCollision().strength(1.0F, 0.0F)));

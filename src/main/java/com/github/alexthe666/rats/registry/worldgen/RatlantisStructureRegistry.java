...
public class RatlantisStructureRegistry {
	...
	public static void bootstrapStructures(BootstrapContext<Structure> context) {
		...
		context.register(DUTCHRAT_SHIP, new JigsawStructure(new Structure.StructureSettings(biomes.getOrThrow(RatlantisBiomeTags.DUTCHRAT_SHIP_SPAWNS), Map.of(MobCategory.MONSTER, new StructureSpawnOverride(StructureSpawnOverride.BoundingBoxType.STRUCTURE, WeightedList.<MobSpawnSettings.SpawnerData>builder().add(new MobSpawnSettings.SpawnerData(RatlantisEntityRegistry.GHOST_PIRAT.get(), 1, 1), 1).build())), GenerationStep.Decoration.SURFACE_STRUCTURES, TerrainAdjustment.NONE), pools.getOrThrow(DUTCHRAT_SHIP_START), 1, ConstantHeight.of(VerticalAnchor.absolute(50)), false, Heightmap.Types.WORLD_SURFACE_WG));
	}

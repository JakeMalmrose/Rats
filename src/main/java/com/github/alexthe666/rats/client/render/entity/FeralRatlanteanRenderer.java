...
public class FeralRatlanteanRenderer extends MobRenderer<FeralRatlantean, LivingEntityRenderState, RatsEntityModelBridge<FeralRatlantean>> {
	...
	public Identifier getTextureLocation(LivingEntityRenderState state) {
		if (RatsClientKeys.getLiving(state) instanceof FeralRatlantean entity) {
